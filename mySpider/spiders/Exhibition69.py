...
# @Author  : 10711
# @File    : Exhibition69.py
# @Software: PyCharm


from ..items import *
from ..str_filter import *
from ..auxiliary_files import Exhibition69_supporting

class Exhibition69(scrapy.Spider):
    name = "Exhibition69"
    allowed_domains = ['njmuseumadmin.com']
    start_urls = Exhibition69_supporting.Exhibition69Supporting.startUrl
