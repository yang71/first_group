...
# @Author  : 10711
# @File    : Exhibition62.py
# @Software: PyCharm


from ..items import *
from ..str_filter import *
from ..auxiliary_files import Exhibition62_supporting

class Exhibition62(scrapy.Spider):
    name = "Exhibition62"
    allowed_domains = ['njmuseumadmin.com']
    start_urls = Exhibition62_supporting.Exhibition62Supporting.startUrl
