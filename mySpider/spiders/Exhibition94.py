...
# @Author  : 10711
# @File    : Exhibition94.py
# @Software: PyCharm


from ..items import *
from ..str_filter import *
from ..auxiliary_files import Exhibition94_supporting

class Exhibition94(scrapy.Spider):
    name = "Exhibition94"
    allowed_domains = ['njmuseumadmin.com']
    start_urls = Exhibition94_supporting.Exhibition94Supporting.startUrl
