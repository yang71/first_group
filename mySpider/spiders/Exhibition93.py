...
# @Author  : 10711
# @File    : Exhibition93.py
# @Software: PyCharm


from ..items import *
from ..str_filter import *
from ..auxiliary_files import Exhibition93_supporting

class Exhibition93(scrapy.Spider):
    name = "Exhibition93"
    allowed_domains = ['baike.baidu.com']
    start_urls = Exhibition93_supporting.Exhibition93Supporting.startUrl
