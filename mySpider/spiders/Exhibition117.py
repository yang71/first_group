...
# @Author  : 10711
# @File    : Exhibition117.py
# @Software: PyCharm


from ..items import *
from ..str_filter import *
from ..auxiliary_files import Exhibition117_supporting

class Exhibition117(scrapy.Spider):
    name = "Exhibition117"
    allowed_domains = ['njmuseumadmin.com']
    start_urls = Exhibition117_supporting.Exhibition117Supporting.startUrl
