...
# @Author  : 10711
# @File    : Exhibition114.py
# @Software: PyCharm


from ..items import *
from ..str_filter import *
from ..auxiliary_files import Exhibition114_supporting

class Exhibition114(scrapy.Spider):
    name = "Exhibition114"
    allowed_domains = ['njmuseumadmin.com']
    start_urls = Exhibition114_supporting.Exhibition114Supporting.startUrl
