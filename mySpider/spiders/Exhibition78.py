...
# @Author  : 10711
# @File    : Exhibition78.py
# @Software: PyCharm


from ..items import *
from ..str_filter import *
from ..auxiliary_files import Exhibition78_supporting

class Exhibition78(scrapy.Spider):
    name = "Exhibition78"
    allowed_domains = ['njmuseumadmin.com']
    start_urls = Exhibition78_supporting.Exhibition78Supporting.startUrl
