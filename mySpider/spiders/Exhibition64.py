...
# @Author  : 10711
# @File    : Exhibition64.py
# @Software: PyCharm


from ..items import *
from ..str_filter import *
from ..auxiliary_files import Exhibition64_supporting

class Exhibition64(scrapy.Spider):
    name = "Exhibition64"
    allowed_domains = ['njmuseumadmin.com']
    start_urls = Exhibition64_supporting.Exhibition64Supporting.startUrl
