...
# @Author  : 10711
# @File    : Exhibition112.py
# @Software: PyCharm


from ..items import *
from ..str_filter import *
from ..auxiliary_files import Exhibition112_supporting

class Exhibition112(scrapy.Spider):
    name = "Exhibition112"
    allowed_domains = ['njmuseumadmin.com']
    start_urls = Exhibition112_supporting.Exhibition112Supporting.startUrl
