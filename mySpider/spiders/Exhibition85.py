...
# @Author  : 10711
# @File    : Exhibition85.py
# @Software: PyCharm


from ..items import *
from ..str_filter import *
from ..auxiliary_files import Exhibition85_supporting

class Exhibition85(scrapy.Spider):
    name = "Exhibition85"
    allowed_domains = ['njmuseumadmin.com']
    start_urls = Exhibition85_supporting.Exhibition85Supporting.startUrl
