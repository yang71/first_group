...
# @Author  : 10711
# @File    : Exhibition92.py
# @Software: PyCharm


from ..items import *
from ..str_filter import *
from ..auxiliary_files import Exhibition92_supporting

class Exhibition92(scrapy.Spider):
    name = "Exhibition92"
    allowed_domains = ['njmuseumadmin.com']
    start_urls = Exhibition92_supporting.Exhibition92Supporting.startUrl
